...
(custom-set-variables
 ...
 '(package-selected-packages
   '(tree-sitter-langs tree-sitter selectrum-prescient selectrum lsp-ui helm-lsp mz-testdrive helm-fd flycheck-mypy flymake-mypy vterm deadgrep protobuf-mode clojure-mode terraform-mode use-package helm-rg edit-server flymake-shellcheck projectile avy company-go powerline plantuml-mode smart-mode-line visual-fill-column elpy polymode helm-flycheck expand-region multiple-cursors yasnippet yaml-mode web-mode toml-mode rust-mode py-gnitset paredit org-plus-contrib markdown-mode json-mode htmlize highlight-escape-sequences highlight helm-swoop helm-git-grep go-mode gitconfig-mode git-rebase-mode git-commit-mode flycheck-rust f dockerfile-mode diminish crontab-mode color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized))
