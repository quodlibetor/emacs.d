...
;; helm-highlight-current-line replaced helm-match-line-color-current-line in
;; Nov 2013
(if (fboundp 'helm-match-line-color-current-line)
    (defalias 'helm-git-grep-highlight-current-line 'helm-match-line-color-current-line)
  (defalias 'helm-git-grep-highlight-current-line 'helm-highlight-current-line))
...
With a prefix arg record CANDIDATE in `mark-ring'."
  ...
  (helm-git-grep-highlight-current-line))
