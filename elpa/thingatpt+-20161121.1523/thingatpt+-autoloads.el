...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "thingatpt+" '("forward-whitespace-&-newlines" "tap-" "hex-number-at-point" "decimal-number-at-point")))
