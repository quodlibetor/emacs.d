...
(defvar confluence-format-prefix-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map (kbd "C-i") 'confluence-italicize-text)
    (define-key map "c" 'confluence-codify-text)
    (define-key map (kbd "C-c") 'confluence-codify-text)
    (define-key map "b" 'confluence-boldify-text)
    (define-key map (kbd "C-b") 'confluence-boldify-text)
    (define-key map "l" 'confluence-linkify-text)
    (define-key map (kbd "C-l") 'confluence-linkify-text)
    (define-key map "u" 'confluence-underline-text)
    (define-key map (kbd "C-u") 'confluence-underline-text)
    (define-key map "a" 'confluence-linkify-anchor-text)
    (define-key map (kbd "C-a") 'confluence-linkify-anchor-text)
    (define-key map "t" 'confluence-linkify-attachment-text)
    (define-key map (kbd "C-t") 'confluence-linkify-attachment-text)
    (define-key map "A" 'confluence-insert-anchor)
    (define-key map (kbd "C-A") 'confluence-insert-anchor)
    (define-key map "e" 'confluence-embed-text)
    (define-key map (kbd "C-e") 'confluence-embed-text)
    (define-key map "h" 'confluence-insert-horizontal-rule)
    (define-key map (kbd "C-h") 'confluence-insert-horizontal-rule)
    (define-key map "s" 'confluence-superscript-text)
    (define-key map (kbd "C-s") 'confluence-superscript-text)
    (define-key map "S" 'confluence-subscript-text)
    (define-key map (kbd "C-S") 'confluence-subscript-text)
    (define-key map "C" 'confluence-cite-text)
    (define-key map (kbd "C-C") 'confluence-cite-text)
    (define-key map "x" 'confluence-strike-text)
    (define-key map (kbd "C-x") 'confluence-strike-text)
    map)
